...
.Navigation-Icon {
    width: 5rem;
    /* Equivalent to w-20 in Tailwind units (1rem is 20px) */
    height: 5rem;
    /* Equivalent to h-20 in Tailwind units (1rem is 20px) */
    fill: white;
    /* Equivalent to fill-current in Tailwind */
}</style>
