        ...
        <div class="Wrapper">
            <div class="Box">
                <div class="TitleWrapper">
                    <h1 class="Title">Are you sure you want to delete the following user?</h1>
                </div>
                <form :action="route('admin.users.destroy', { user: user.id })" method="POST">
                    ...
                    <div class="FormGrid">
                        <div class="Column">
                            <label>User Name
                                <span class="Span">Current user name</span>
                            </label>
                            <input type="text" placeholder="User name" class="Input" :value="user.name" :disabled="true" />
                        </div>
                        <div class="Column">
                            <label>User
                                <span class="Span">Current user email</span>
                            </label>
                            <input type="text" placeholder="User email" class="Input" :value="user.email" :disabled="true" />
                        </div>
                        <div class="Column">
                            ...
                            <select name="is_admin" class="Input" :disabled="true">
